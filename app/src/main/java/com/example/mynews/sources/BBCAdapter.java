...
public class BBCAdapter extends RecyclerView.Adapter<BBCAdapter.ViewHolder> {
    private List<Article> articleArrayList;

    public BBCAdapter(List<Article> articleArrayList) {
        this.articleArrayList = articleArrayList;
    }

    @Override
    public BBCAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.bbc_item, viewGroup, false);
        return new BBCAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(BBCAdapter.ViewHolder viewHolder, int position) {
