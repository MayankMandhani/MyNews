...
public class NBCAdapter extends RecyclerView.Adapter<NBCAdapter.ViewHolder> {
    private List<Article> articleArrayList;

    public NBCAdapter(List<Article> articleArrayList) {
        this.articleArrayList = articleArrayList;
    }

    @Override
    public NBCAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.nbc_item, viewGroup, false);
        return new NBCAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(NBCAdapter.ViewHolder viewHolder, int position) {
