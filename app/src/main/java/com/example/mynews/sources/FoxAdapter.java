...
public class FoxAdapter extends RecyclerView.Adapter<FoxAdapter.ViewHolder> {
    ...
    public FoxAdapter(List<Article> articleArrayList) {
        this.articleArrayList = articleArrayList;
    }

    @Override
    public FoxAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.fox_item, viewGroup, false);
        return new FoxAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(FoxAdapter.ViewHolder viewHolder, int position) {
