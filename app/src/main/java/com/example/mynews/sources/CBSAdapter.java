...
public class CBSAdapter extends RecyclerView.Adapter<CBSAdapter.ViewHolder> {
    private List<Article> articleArrayList;

    public CBSAdapter(List<Article> articleArrayList) {
        this.articleArrayList = articleArrayList;
    }

    @Override
    public CBSAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.cbs_item, viewGroup, false);
        return new CBSAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(CBSAdapter.ViewHolder viewHolder, int position) {
