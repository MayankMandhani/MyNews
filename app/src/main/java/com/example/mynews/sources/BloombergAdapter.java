...
public class BloombergAdapter extends RecyclerView.Adapter<BloombergAdapter.ViewHolder> {
    private List<Article> articleArrayList;

    public BloombergAdapter(List<Article> articleArrayList) {
        this.articleArrayList = articleArrayList;
    }

    @Override
    public BloombergAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.bloomberg_item, viewGroup, false);
        return new BloombergAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(BloombergAdapter.ViewHolder viewHolder, int position) {
