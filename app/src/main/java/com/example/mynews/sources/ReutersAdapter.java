...
public class ReutersAdapter extends RecyclerView.Adapter<ReutersAdapter.ViewHolder> {
    private List<Article> articleArrayList;

    public ReutersAdapter(List<Article> articleArrayList) {
        this.articleArrayList = articleArrayList;
    }

    @Override
    public ReutersAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.reuters_item, viewGroup, false);
        return new ReutersAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ReutersAdapter.ViewHolder viewHolder, int position) {
