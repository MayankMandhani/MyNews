...
public class WashingtonAdapter extends RecyclerView.Adapter<WashingtonAdapter.ViewHolder> {
    private List<Article> articleArrayList;

    public WashingtonAdapter(List<Article> articleArrayList) {
        this.articleArrayList = articleArrayList;
    }

    @Override
    public WashingtonAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.washington_item, viewGroup, false);
        return new WashingtonAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(WashingtonAdapter.ViewHolder viewHolder, int position) {
