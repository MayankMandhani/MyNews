...
public class CNNAdapter extends RecyclerView.Adapter<CNNAdapter.ViewHolder> {
    private List<Article> articleArrayList;

    public CNNAdapter(List<Article> articleArrayList) {
        this.articleArrayList = articleArrayList;
    }

    @Override
    public CNNAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.cnn_item, viewGroup, false);
        return new CNNAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(CNNAdapter.ViewHolder viewHolder, int position) {
