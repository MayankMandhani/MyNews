...
public class ArsAdapter extends RecyclerView.Adapter<ArsAdapter.ViewHolder> {
    ...
    public ArsAdapter(List<Article> articleArrayList) {
        this.articleArrayList = articleArrayList;
    }

    @Override
    public ArsAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.ars_item, viewGroup, false);
        return new ArsAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ArsAdapter.ViewHolder viewHolder, int position) {
